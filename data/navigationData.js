const navigationData = {
    ...
    navItems: [
        { href: "#about", text: "About", class: "nav-item nav-link tilt" },
        ...
        { href: "#contact", text: "Contact", class: "nav-item nav-link tilt" }
    ],
    ctaButton: {
        href: "https://www.linkedin.com/in/alok22/",
        text: "Connect With Me!",
        class: "btn btn-outline-primary d-none d-lg-block tilt",
